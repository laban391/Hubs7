...
async function main() {
    ...
    const DOMAIN = await getVariableValue('DOMAIN', 'https://hubs7s-laban-bustybootyass-777-151082259460.us-west1.run.app');// 为保证安全隐蔽，建议留空，可在Node.js界面下的环境变量添加处（Environment variables）,点击ADD VARIABLE，修改变量
